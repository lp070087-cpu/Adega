 ...
 *
 * ── Acessibilidade ──
 * `prefers-reduced-motion` desliga tudo. Sem isso, quem sente desconforto
 * com movimento recebe card flutuando na cara logo na abertura do site.
 *
...
export type DynamicStoreHeroProps = {
  ...
  /** Banner principal. Sem banner, o hero usa só a cor da marca. */
  banners?: HeroBanner[];
      ...
      */}
      ...
      <div className="store-hero-bg" aria-hidden="true">
        {banner ? (
          ...
          <img src={banner.imagePath} alt="" className="store-hero-banner" />
        ) : null}
...
.store-hero-banner { width: 100%; height: 100%; object-fit: cover; opacity: 0.22; }
...
.store-hero-dot { width: 7px; height: 7px; border-radius: 50%; background: currentColor; }
...
/* Sem movimento: tudo aparece parado e legível. */
